...
// =============================================================================
// Pattern: ogni route placeholder del verticale (clienti/fatture) e' una
// page.tsx 1-line che istanzia <PlaceholderPage section="..."/> con la chiave
// i18n del namespace `placeholder.<section>`.
//
// Razionale shared component vs file duplicati: zero copy-paste drift,
// modifica futura (es. aggiungere badge / icona / link doc) propaga
// automatica a tutti i placeholder.
// =============================================================================

type PlaceholderSection = 'clienti' | 'fatture';
