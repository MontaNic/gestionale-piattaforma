...
// =============================================================================
// i18n/request.ts — entrypoint next-intl per apps/accountant-web (ADR-0027 §D5 passo 4)
// =============================================================================
...
// verticale commercialisti, NON core. `createNextIntlPlugin` punta a questo file
