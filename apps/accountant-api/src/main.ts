// =============================================================================
// main.ts — Entrypoint apps/accountant-api (NestJS bootstrap)
// =============================================================================
// Avvia NestJS su PORT (default 3002). Reflect-metadata richiesto
...
async function bootstrap(): Promise<void> {
  ...
  Logger.log(`Gestionale Accountant API listening on http://localhost:${port}/api/v1`, 'Bootstrap');
}
