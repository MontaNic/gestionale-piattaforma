...
// =============================================================================
// create-azienda.dto.ts — anagrafica clienti (verticale accountant, STOP-c1)
// =============================================================================
// MVP 15 campi (no RFM, no arricchimento). I `message` dei decorator sono gli
// errorCode E_AZIENDA_* (convenzione restaurant-api: message = errorCode).
// =============================================================================

export class CreateAziendaDto {
