// =============================================================================
// update-servizio-catalogo.dto.ts — Body PATCH /catalogo/servizi/:id (ADR-0050)
// =============================================================================
// PartialType-like manuale: tutti i campi opzionali, stessi vincoli del create.
// =============================================================================
...
export class UpdateServizioCatalogoDto {
  @IsOptional()
