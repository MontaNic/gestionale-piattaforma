...
// =============================================================================
// create-referente.dto.ts — referente azienda (STOP-c3a ADR-0033)
// =============================================================================
// MVP 6 campi (nome, ruolo, email, telefono, note, attivo). `user_id` deferito.
// Convenzione: message dei decorator = errorCode E_REFERENTE_*.
// =============================================================================
